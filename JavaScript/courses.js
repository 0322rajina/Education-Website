 // Course data
        const courses = {
            1: {
                ...
                description: "Learn to build modern web applications from scratch using HTML, CSS, JavaScript, React, Node.js, and more. This comprehensive bootcamp will take you from beginner to job-ready developer with hands-on projects and real-world applications.",
                outcomes: [
            ...
            2: {
                ...
                description: "Master the fundamentals of data science, statistical analysis, and machine learning algorithms using Python. This course provides a solid foundation in data manipulation, visualization, and predictive modeling.",
                outcomes: [
            ...
            3: {
                ...
                description: "Learn SEO, social media marketing, content marketing, email campaigns, and analytics to grow any business. This masterclass covers both strategy and practical implementation for digital marketing success.",
                outcomes: [
            ...
            4: {
                ...
                description: "Learn the fundamentals of user interface and experience design, including wireframing, prototyping, and usability testing. This course covers both the theoretical principles and practical skills needed to create effective digital experiences.",
                outcomes: [
            ...
            5: {
                ...
                description: "Dive deep into Python programming with advanced topics including decorators, generators, concurrency, and more. This course is designed for those who already know Python basics and want to master advanced concepts and patterns.",
                outcomes: [
            ...
            6: {
                ...
                description: "Learn to build native mobile applications for both iOS and Android platforms using modern development tools. This comprehensive course covers everything from UI design to backend integration for mobile apps.",
                outcomes: [
        ...
        viewDetailsButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                if (course) {
                    ...
                    document.getElementById('modal-course-price-current').textContent = course.price.current;
                    document.getElementById('modal-course-price-original').textContent = course.price.original;
